...
var smoothscroll_1 = smoothscroll.polyfill;function _toConsumableArray(arr) {
...
var script = {
  ...
  computed: {
    ...
    _options: function _options() {
      ...
      return {
        ...
        responsive: [].concat(_toConsumableArray((_options$responsive = options === null || options === void 0 ? void 0 : options.responsive) !== null && _options$responsive !== void 0 ? _options$responsive : []), [// Fallback default responsive
        {
          end: 576,
          size: 1
        }, {
  ...
  methods: {
    ...
    go: function go(position) {
      var maxPosition = this._length - this._size;
...
var __vue_render__ = function __vue_render__() {
  ...
  }, [_vm.width.window > _vm._options.navigation.start ? _vm._ssrNode("<div class=\"vhl-navigation\" data-v-8b923bbc>", "</div>", [_vm._hasPrev ? _vm._ssrNode("<div class=\"vhl-btn-left\" data-v-8b923bbc>", "</div>", [_vm._t("nav-prev", [_c('svg', {
    attrs: {
  ...
  })])])], 2) : _vm._e(), _vm._ssrNode(" "), _vm._hasNext ? _vm._ssrNode("<div class=\"vhl-btn-right\" data-v-8b923bbc>", "</div>", [_vm._t("nav-next", [_c('svg', {
    attrs: {
      "fill": _vm._options.navigation.color,
      "width": "32px",
      "height": "32px",
  ...
  })])])], 2) : _vm._e()], 2) : _vm._e(), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"vhl-container\"" + _vm._ssrStyle(null, _vm._style.container, null) + " data-v-8b923bbc>", "</div>", [_vm._ssrNode("<div" + _vm._ssrClass("vhl-list", _vm._options.list.class) + _vm._ssrStyle(null, _vm._style.list, null) + " data-v-8b923bbc>", "</div>", [_vm._l(_vm._items, function (item) {
    return _vm._ssrNode("<div" + _vm._ssrClass("vhl-item", _vm._options.item.class) + _vm._ssrStyle(null, _vm._style.item, null) + " data-v-8b923bbc>", "</div>", [item.type === 'start' ? _vm._t("start") : item.type === 'end' ? _vm._t("end") : item.type === 'item' ? _vm._t("default", [_vm._v(_vm._s(item))], {
      "item": item.item
    }) : _vm._e()], 2);
  }), _vm._ssrNode(" <div" + _vm._ssrStyle(null, _vm._style.tail, null) + " data-v-8b923bbc></div>")], 2)])], 2);
};
...
var __vue_scope_id__ = "data-v-8b923bbc";
/* module identifier */

var __vue_module_identifier__ = "data-v-8b923bbc";
/* functional template */
...
var install = function installVueHorizontalList(Vue) {
