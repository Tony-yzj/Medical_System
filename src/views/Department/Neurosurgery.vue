<template>
  <div>
    <div class="department">
      <h2 class="title">神经外科</h2>
      <p class="description">神经外科是一门外科学科，涉及对神经系统疾病和损伤的外科手术治疗。</p>
    </div>
      ...
      doctors: [
        {
          name: '张外',
          title: '主任医师',
          introduction: '张外是神经外科主任医师，从事神经外科临床工作30余年，擅长颅脑肿瘤、脑血管病、脊髓病、周围神经病、癫痫等疾病的诊治。'
        },
        {
          name: '李元',
          title: '副主任医师',
          introduction: '李元是神经外科副主任医师，从事神经外科临床工作20余年，接受过国内外进修。'
        }
      ],
      selectedDay: null,
