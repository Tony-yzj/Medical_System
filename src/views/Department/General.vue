<template>
  <div>
    <div class="department">
      <h2 class="title">普外科</h2>
      <p class="description">普外科是外科学科的一个分支，专注于诊断、治疗和管理各种外科疾病和病情。它涵盖了许多常见的外科问题和手术程序，旨在改善患者的健康和生活质量。</p>
    </div>
      ...
      doctors: [
        {
          name: '王普',
          title: '主任医师',
          introduction: '王普是普外科的主任医师，具备丰富的临床经验。'
        },
        {
          name: '李外',
          title: '副主任医师',
          introduction: '李外是是普外科的副主任医师，擅长肝胆胰脾疾病的治疗。'
        }
      ],
      selectedDay: null,
