<template>
  <div>
    <div class="department">
      <h2 class="title">呼吸内科</h2>
      <p class="description">呼吸内科专注于呼吸系统的疾病和病情，包括肺部、支气管、气管和胸腔的疾病。</p>
    </div>
      ...
      doctors: [
        {
          name: '张呼',
          title: '主任医师',
          introduction: '张三是呼吸内科的主任医师，擅长肺部疾病的治疗。'
        },
        {
          name: '李吸',
          title: '副主任医师',
          introduction: '李四是呼吸内科的副主任医师，擅长支气管炎的治疗。'
        }
      ],
      selectedDay: null,
