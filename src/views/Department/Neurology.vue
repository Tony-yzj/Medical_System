<template>
  <div>
    <div class="department">
      <h2 class="title">神经内科</h2>
      <p class="description">神经内科专注于神经系统的疾病和病情，包括大脑、脊髓、周围神经和肌肉的疾病。</p>
    </div>
      ...
      doctors: [
        {
          name: '张神',
          title: '主任医师',
          introduction: '张神是神经内科的主任医师，擅长神经系统疾病的治疗。'
        },
        {
          name: '李经',
          title: '副主任医师',
          introduction: '李经是神经内科的副主任医师，处理神经系统疾病有丰富的经验。'
        }
      ],
      selectedDay: null,
