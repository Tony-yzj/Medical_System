<template>
  <div>
    <div class="department">
      <h2 class="title">小儿神经科</h2>
      <p class="description">小儿神经科是专门关注儿童神经系统疾病的医学专业。小儿神经科医生诊断和治疗影响儿童神经系统的疾病，包括癫痫、脑瘫、神经发育障碍、神经肌肉疾病和其他神经学问题。</p>
    </div>
      ...
      doctors: [
        {
          name: '张邵',
          title: '主任医师',
          introduction: '张邵是小儿神经科的主任医师，擅长癫痫、脑瘫、神经发育障碍、神经肌肉疾病和其他神经学问题的治疗。'
        },
        {
          name: '李念',
          title: '副主任医师',
          introduction: '李念是小儿神经科的副主任医师，负责小儿神经科的日常工作。'
        }
      ],
      selectedDay: null,
