<template>
  <div>
    <div class="department">
      <h2 class="title">小儿外科</h2>
      <p class="description">小儿外科是专注于儿童的外科学科，处理儿童的先天性畸形、创伤、肿瘤和其他外科问题。</p>
    </div>
      ...
      doctors: [
        {
          name: '张歪',
          title: '主任医师',
          introduction: '张歪是小儿外科的主任医师，擅长小儿先天性畸形的治疗。'
        },
        {
          name: '李彤',
          title: '实习医师',
          introduction: '李彤是小儿外科的实习医师，辅助张歪主任医师进行手术。'
        }
      ],
      selectedDay: null,
