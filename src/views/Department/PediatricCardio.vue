<template>
  <div>
    <div class="department">
      <h2 class="title">小儿心脏科</h2>
      <p class="description">小儿心脏科是专注于儿童心脏疾病的医学专业。小儿心脏科医生负责诊断、治疗和管理儿童的先天性心脏病、心脏血管问题和其他心脏相关疾病。</p>
    </div>
      ...
      doctors: [
        {
          name: '张藏',
          title: '主任医师',
          introduction: '张藏是小儿心脏科的主任医师，擅长先天性心脏病的治疗。'
        },
        {
          name: '李点',
          title: '副主任医师',
          introduction: '李点是小儿心脏科的副主任医师，进行过多次心脏手术。'
        }
      ],
      selectedDay: null,
