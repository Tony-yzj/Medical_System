<template>
  <div>
    <div class="department">
      <h2 class="title">泌尿内科</h2>
      <p class="description">泌尿外科专注于泌尿系统和男性生殖系统的疾病和病情，包括肾脏、膀胱、前列腺、尿道等器官的问题。</p>
    </div>
      ...
      doctors: [
        {
          name: '张光',
          title: '主任医师',
          introduction: '张光是泌尿外科的主任医师，擅长泌尿系统的疾病和病情。'
        },
        {
          name: '李必',
          title: '副主任医师',
          introduction: '李必是泌尿外科的副主任医师，很有经验。'
        }
      ],
      selectedDay: null,
